...
ThemeOptions.propTypes = {
  ...
  setEnableBackgroundImage: PropTypes.func,
  enableFixedHeader: PropTypes.bool,
  setEnableFixedHeader: PropTypes.func,
  setEnableHeaderShadow: PropTypes.func,
  enableSidebarShadow: PropTypes.bool,
  setEnableSidebarShadow: PropTypes.func,
  enableFixedSidebar: PropTypes.bool,
  setEnableFixedSidebar: PropTypes.func,
  enablePageTitleIcon: PropTypes.bool,
  setEnablePageTitleIcon: PropTypes.func,
  enablePageTitleSubheading: PropTypes.bool,
  setEnablePageTitleSubheading: PropTypes.func,
  enablePageTabsAlt: PropTypes.bool,
  setEnablePageTabsAlt: PropTypes.func,
  enableFixedFooter: PropTypes.bool,
  setEnableFixedFooter: PropTypes.func,
  backgroundColor: PropTypes.string,
  setBackgroundColor: PropTypes.func,
  headerBackgroundColor: PropTypes.string,
  setHeaderBackgroundColor: PropTypes.func,
  colorScheme: PropTypes.string,
  setColorScheme: PropTypes.func,
  backgroundImageOpacity: PropTypes.string,
  setBackgroundImageOpacity: PropTypes.func,
